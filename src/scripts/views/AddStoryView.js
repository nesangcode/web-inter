export class AddStoryView {
      ...
      <section class="container">
        <div class="add-story-container">
          <div class="add-story-header">
            ...
            <p>Ceritakan pengalaman belajar Anda di Dicoding</p>
          </div>
            ...
            <fieldset class="form-group">
              ...
              <div class="location-section">
                ...
                <div class="location-options" style="display: none;">
                  <button type="button" id="current-location-btn" class="btn btn-outline btn-small">
                    📍 Gunakan Lokasi Saat Ini
                  </button>
                  <button type="button" id="select-map-location-btn" class="btn btn-outline btn-small">
                    🗺️ Pilih di Peta
                  </button>
                </div>
  ...
  displayPhotoPreview(file) {
    ...
    reader.onload = (e) => {
      ...
      `;
      photoPreview.querySelector('.change-photo-btn').addEventListener('click', () => {
        document.getElementById('photo').click();
      });
    };
  ...
  toggleLocationOptions(show) {
    document.querySelector('.location-options').style.display = show ? 'flex' : 'none';
    if (!show) {
  ...
  showLocationStatus(message) {
    ...
    locationInfo.querySelector('.location-status').textContent = message;
  ...
  showSuccess(message, redirectUrl, redirectText) {
    const formError = document.getElementById('form-error');
    formError.innerHTML = `
      <div class="success-message">
        <p>✅ ${message}</p>
        <a href="${redirectUrl}" class="btn btn-primary">${redirectText}</a>
      </div>
    `;
